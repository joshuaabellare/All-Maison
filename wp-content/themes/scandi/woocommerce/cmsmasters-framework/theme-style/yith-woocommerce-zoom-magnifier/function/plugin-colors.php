...
function scandi_yith_woocommerce_zoom_magnifier_colors($custom_css) {
...
add_filter('scandi_theme_colors_secondary_filter', 'scandi_yith_woocommerce_zoom_magnifier_colors');
