...
function scandi_product_meta_fields($custom_all_meta_fields) {
		...
		foreach ($custom_all_meta_fields as $custom_all_meta_field) {
			if ($custom_all_meta_field['id'] == 'cmsmasters_sidebar_id') {
				...
				$tabs_array['cmsmasters_product'] = array( 
					'label' => esc_html__('Product', 'scandi'), 
				...
				$custom_all_meta_fields_new[] = array( 
					'label'	=> esc_html__('Product Size', 'scandi'), 
					'desc'	=> esc_html__('Recommended Featured Image dimensions, or other size, with the same ratio', 'scandi') . ' - ', 
...
add_filter('get_custom_all_meta_fields_filter', 'scandi_product_meta_fields');