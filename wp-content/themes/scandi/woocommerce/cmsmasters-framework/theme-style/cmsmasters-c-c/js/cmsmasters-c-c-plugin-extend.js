...
cmsmastersShortcodes.cmsmasters_selected_products = {
	...
	fields : { 
		...
		categories : { 
			type : 		'checkbox', 
			title : 	cmsmasters_woocommerce_shortcodes.product_categories_title, 
			descr : 	cmsmasters_woocommerce_shortcodes.show_product_categories_descr, 
			def : 		'', 
			required : 	false, 
			width : 	'half', 
			choises : { 
...
cmsmastersShortcodes.cmsmasters_product_category = {
	...
	fields : { 
		...
		category : { 
			...
			required : 	true, 
			width : 	'half', 
			choises : 	scandi_composer_product_cat() 
		}, 
		// Order By
		orderby : { 
			type : 		'select', 
