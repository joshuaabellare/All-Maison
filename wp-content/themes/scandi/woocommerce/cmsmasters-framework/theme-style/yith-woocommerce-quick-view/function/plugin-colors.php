...
function scandi_yith_woocommerce_quick_view_colors($custom_css) {
...
/***************** Start {$title} Yith WooCommerce Quick View Colors Scheme Rules ******************/
	...
	{$rule}.yith-quick-view.scale-in .single-product .yith-wcqv-view-details {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['scandi' . '_' . $scheme . '_heading']) . "
	}
...
add_filter('scandi_theme_colors_secondary_filter', 'scandi_yith_woocommerce_quick_view_colors');
