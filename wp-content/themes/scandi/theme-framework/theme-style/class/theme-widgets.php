...
class WP_Widget_Custom_Contact_Info extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_html__('Your contact information', 'scandi') 
		);
		...
		parent::__construct('custom-contact-info', esc_attr__('Contact Information', 'scandi'), $widget_ops, $control_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Contact Information', 'scandi') : $instance['title'], $instance, $this->id_base);
		...
		if ( 
			...
			echo '<span class="adr adress_wrap contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Address:', 'scandi') . '</span><span class="contact_info_item_desc">';
		}
		...
		if ($time != '') { 
            echo '<span class="contact_widget_time contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Time:', 'scandi') . '</span>' . 
		...
		if ($name != '') { 
            echo '<span class="contact_widget_name  contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Name:', 'scandi') . '</span>' . 
        ...
        if ($url != '') { 
            echo '<span class="contact_widget_url contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('URL:', 'scandi') . '</span>' . 
        ...
        if ($email != '') { 
            echo '<span class="contact_widget_email contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Email:', 'scandi') . '</span>' . 
		...
		if ($phone != '') { 
            echo '<span class="contact_widget_phone contact_info_item">' . 
				'<span class="contact_info_item_title">' . esc_html__('Phone:', 'scandi') . '</span>' . 
    ...
    function form($instance) {
        ...
        ?>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'scandi'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Name', 'scandi'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('name')); ?>" name="<?php echo esc_attr($this->get_field_name('name')); ?>" type="text" value="<?php echo esc_attr($name); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php esc_html_e('Website', 'scandi'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('url')); ?>" name="<?php echo esc_attr($this->get_field_name('url')); ?>" type="text" value="<?php echo esc_attr($url); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email', 'scandi'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('email')); ?>" name="<?php echo esc_attr($this->get_field_name('email')); ?>" type="text" value="<?php echo esc_attr($email); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone', 'scandi'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('phone')); ?>" name="<?php echo esc_attr($this->get_field_name('phone')); ?>" type="text" value="<?php echo esc_attr($phone); ?>" />
            </label>
        </p>
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address', 'scandi'); ?>:<br />
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id('address')); ?>" name="<?php echo esc_attr($this->get_field_name('address')); ?>" type="text" value="<?php echo esc_attr($address); ?>" />
            </label>
        </p>
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('city')); ?>"><?php esc_html_e('City', 'scandi'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('state')); ?>"><?php esc_html_e('State', 'scandi'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('zip')); ?>"><?php esc_html_e('Zip', 'scandi'); ?>:<br />
        ...
        <p class="r_half">
            <label for="<?php echo esc_attr($this->get_field_id('country')); ?>"><?php esc_html_e('Country', 'scandi'); ?>:<br />
        ...
        <p class="l_half">
            <label for="<?php echo esc_attr($this->get_field_id('time')); ?>"><?php esc_html_e('Time', 'scandi'); ?>:<br />
...
class WP_Widget_Custom_Latest_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest projects from your portfolio', 'scandi') 
		);
		
		parent::__construct('custom-latest-projects', esc_attr__('Latest Projects', 'scandi'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Latest Projects', 'scandi') : $instance['title'], $instance, $this->id_base);
        ...
        if ($lp->have_posts()) { 
            ...
            while ($lp->have_posts()) : $lp->the_post();
				...
				echo '<div class="cmsmasters_owl_slider_item cmsmasters_slider_project">' . 
					...
					scandi_slider_post_heading(get_the_ID(), 'project', 'h3', $cmsmasters_project_link_redirect, $cmsmasters_project_link_url, true, $cmsmasters_project_link_target);
					...
					if($likes == 1 && $comments == 1) {
						...
						echo '<footer class="cmsmasters_slider_project_footer entry-meta">';
							...
							if($likes == 1) {
								scandi_slider_post_like('project');
							}
							
							if($comments == 1) {
								scandi_get_slider_post_comments('project');
							}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('type')); ?>"><?php esc_html_e('Show Only from Projects Type', 'scandi'); ?>:<br />
                <select id="<?php echo esc_attr($this->get_field_id('type')); ?>" name="<?php echo esc_attr($this->get_field_name('type')); ?>" class="widefat">
                    <option value=""><?php esc_html_e('Show all projects', 'scandi'); ?>&nbsp;</option>
				<?php 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest projects you'd like to display", 'scandi'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'scandi'); ?> 3</small><br />
            </label>
        </p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('autoplay')); ?>"><?php esc_html_e('Autoplay', 'scandi'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('likes')); ?>"><?php esc_html_e('Show likes', 'scandi'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('comments')); ?>"><?php esc_html_e('Show comments', 'scandi'); ?></label>
		</p>
        <div class="cl"></div>
        <?php
    }
...
class WP_Widget_Custom_Popular_Projects extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Popular projects from your portfolio', 'scandi') 
		);
		
		parent::__construct('custom-popular-projects', esc_attr__('Popular Projects', 'scandi'), $widget_ops);
	}
	
    function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Popular Projects', 'scandi') : $instance['title'], $instance, $this->id_base);
		$type = isset($instance['type']) ? $instance['type'] : '';
		$number = isset($instance['number']) ? (int) $instance['number'] : '';
        $autoplay = isset($instance['autoplay']) ? $instance['autoplay'] : false;
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of popular projects you'd like to display", 'scandi'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'scandi'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Posts_Tabs extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Latest, popular posts & recent comments', 'scandi') 
		);
		
		parent::__construct('custom-posts-tabs', esc_attr__('Posts Tabs', 'scandi'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		if ($latest) {
			echo '<li class="cmsmasters_tabs_list_item current_tab">' . 
				'<a href="#"><span>' . esc_html__('Latest', 'scandi') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($popular) {
			echo '<li class="cmsmasters_tabs_list_item' . ((!$latest) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Popular', 'scandi') . '</span></a>' . 
			'</li>'; 
		}
		
		if ($recent) {
			echo '<li class="cmsmasters_tabs_list_item' . ((!$latest && !$popular) ? ' current_tab' : '') . '">' . 
				'<a href="#"><span>' . esc_html__('Comments', 'scandi') . '</span></a>' . 
			'</li>'; 
		}
			...
			while ($latest_query->have_posts()) : $latest_query->the_post();
				...
				if ($pt_format == 'image' || $pt_format == 'gallery') {
					...
					if (has_post_thumbnail()) {
						scandi_thumb(get_the_ID(), 'cmsmasters-small-thumb', true, false, false, false, false, true, false);
						...
						foreach ($attachments as $attachment) { 
							if (!isset($att_counter) && $att_counter = true) { 
								scandi_thumb(get_the_ID(), 'cmsmasters-small-thumb', true, false, false, false, false, true, $attachment->ID);
							}
						}
					} else {
		...
		if ($recent) {
			...
			foreach ($rcomments as $comment) {
				...
				echo '<li>' . 
					...
					' <span>' . esc_html__('on', 'scandi') . '</span> <a href="' . get_permalink($comment_post_ID) . '#comments" rel="bookmark">' . cmsmasters_title($comment_post_ID, false) . '</a>' . 
					'<small>' . 
						'<abbr class="published" title="' . esc_attr(get_the_time('d-m-Y')) . '">' . human_time_diff($comment_date, current_time('timestamp')) . ' ' . esc_html__('ago', 'scandi') . '</abbr>' . 
					'</small>' . 
    ...
    function form($instance) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('latest')); ?>"><?php esc_html_e('Latest Posts', 'scandi'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('popular')); ?>"><?php esc_html_e('Popular Posts', 'scandi'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('recent')); ?>"><?php esc_html_e('Recent Comments', 'scandi'); ?></label>
		</p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of recent comments, popular and latest posts you\'d like to display", 'scandi'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'scandi'); ?> 3</small><br />
            </label>
        </p>
...
class WP_Widget_Custom_Twitter extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your Twitter account latest tweets', 'scandi') 
		);
		
		parent::__construct('custom-twitter', esc_attr__('Twitter', 'scandi'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('Twitter', 'scandi') : $instance['title'], $instance, $this->id_base);
		...
		if ($user != '') {
			...
			if ($tweets != '') {
				...
				foreach ($tweets as $t) {
					echo '<li>' . "\n" . 
						'<span class="tweet_time cmsmasters_theme_icon_user_twitter">' . human_time_diff($t['time'], current_time('timestamp')) . ' ' . esc_html__('ago', 'scandi') . '</span>' . "\n" . 
				...
				echo '<div class="cmsmasters_notice cmsmasters_notice_error cmsmasters_theme_icon_cancel">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . esc_html__('Please add your Twitter API keys', 'scandi') . ', ' . '<a target="_blank" href="//cmsmasters.net/twitter-functionality/">' . esc_html__('read more how', 'scandi') . '</a></p>' . "\n" . 
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('user')); ?>"><?php esc_html_e('Twitter Username', 'scandi'); ?>:<br />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest tweets you'd like to display", 'scandi'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'scandi'); ?> 2</small><br />
            </label>
        </p>
        <div class="cl"></div>
        <?php
...
class WP_Widget_Custom_Profile extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_html__('Your info from profiles', 'scandi') 
		);
		
		parent::__construct('custom-profile', esc_attr__('Profile', 'scandi'), $widget_ops);
	}
	
	function widget($args, $instance) {
		extract($args);
		
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_attr__('About Author', 'scandi') : $instance['title'], $instance, $this->id_base);
		...
		if ($id != '') {
			...
			if ($social != '') { 
				scandi_profile_social_icons($cmsmasters_profile_social);
			}
		}
    ...
    function form($instance) {
		...
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('id')); ?>"><?php esc_html_e('Choose Profile to display', 'scandi'); ?>:<br />
                <select id="<?php echo esc_attr($this->get_field_id('id')); ?>" name="<?php echo esc_attr($this->get_field_name('id')); ?>" class="widefat">
                    <option value=""><?php esc_html_e('Choose...', 'scandi'); ?>&nbsp;</option>
				<?php 
					$queryArgs = array( 
						'posts_per_page' => 		-1, 
						'post_status' => 			'publish', 
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_html_e('Profile Featured Image', 'scandi'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('name')); ?>"><?php esc_html_e('Profile Name', 'scandi'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('excerpt')); ?>"><?php esc_html_e('Profile Excerpt', 'scandi'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('social')); ?>"><?php esc_html_e('Profile Social Icons', 'scandi'); ?></label>
		</p>
        <?php
    }
}
...
class WP_Widget_Custom_Latest_Posts extends WP_Widget {
	function __construct() {
		$widget_ops = array( 
			...
			'description' => 	esc_attr__('Your site\'s latest Posts.', 'scandi') 
		);
		
		parent::__construct('custom-latest-posts', esc_attr__('Latest Posts', 'scandi'), $widget_ops);
	}
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Enter the number of latest posts you'd like to display", 'scandi'); ?>:<br /><br />
                <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" />
                <small class="s_red"><?php esc_html_e('default is', 'scandi'); ?> 3</small><br />
            </label>
        </p>
...
function scandi_theme_add_custom_widgets($widgets) {
...
add_filter('cmsmasters_custom_widgets_filter', 'scandi_theme_add_custom_widgets');
