...
function scandi_mytheme_comment($comment, $args, $depth) {
    ?>
			...
			<div class="comment-content cmsmasters_comment_item_cont">
				<div class="cmsmasters_comment_item_header">
					...
					echo '<abbr class="published cmsmasters_comment_item_date" title="' . get_comment_date() . '">' . 
						esc_html__('on', 'scandi') . ' ' . get_comment_date() . 
					'</abbr>';
					?>
				</div>
				<div class="cmsmasters_comment_item_cont_info">
					...
					comment_reply_link(array_merge($args, array( 
						...
						'reply_text' => esc_attr__('Reply', 'scandi') 
					)));
					
					
					edit_comment_link(esc_attr__('Edit', 'scandi'), '', '');
					?>
				</div>
				<div class="cmsmasters_comment_item_content">
					...
					if ($comment->comment_approved == '0') {
						echo '<p>' . 
							'<em>' . esc_html__('Your comment is awaiting moderation.', 'scandi') . '</em>' . 
						'</p>';
					}
					?>
				</div>
