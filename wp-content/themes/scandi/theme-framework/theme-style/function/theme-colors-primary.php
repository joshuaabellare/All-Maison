...
function scandi_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.share_posts a,
	{$rule}.comment-reply-title small #cancel-comment-reply-link {
	...
	{$rule}.search_bar_wrap .search_button:hover,
	{$rule}.button,
	{$rule}button,
	...
	{$rule}.product .cmsmasters_tabs .cmsmasters_tabs_list_item a:hover,
	{$rule}.share_posts a:hover,
	{$rule}.cmsmasters_tabs .cmsmasters_tabs_list_item a:hover,
	{$rule}.comment-reply-title small #cancel-comment-reply-link:hover {
	...
	{$rule}button:hover,
	{$rule}.button:hover,
	{$rule}.comment-form-comment textarea:focus {
	...
	{$rule}h5 a,
	{$rule}h6 a,
	{$rule}.comment-respond .comment-form-author label, 
	{$rule}.comment-respond .comment-form-email label, 
	{$rule}.comment-respond .comment-form-comment label,
	...
	{$rule}form .formError .formErrorContent {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['scandi' . '_' . $scheme . '_heading']) . "
	}
	...
	{$rule}.select2-results__options {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['scandi' . '_' . $scheme . '_bg']) . "
	}
	
	{$rule}.cmsmasters_slider_project_category a,
	{$rule}.cmsmasters_project_puzzle .cmsmasters_project_category a {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['scandi' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.search_bar_wrap .search_button .cmsmasters_theme_icon_search,
	{$rule}.search_bar_wrap .search_button .cmsmasters_theme_icon_search:hover,
	{$rule}.widget_tag_cloud a,
	{$rule}#wp-calendar thead th,
	{$rule}#wp-calendar thead td {
	...
	{$rule}.sidebar .widget,
	{$rule}input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]),
	{$rule}.cmsmasters-form-builder textarea,
	...
	{$rule}.commentlist > .comment .cmsmasters_comment_item,
	{$rule}textarea,
	...
	{$rule}.after_header_mid_search_wraper:before,
	{$rule}.share_posts:before,
	{$rule}.cmsmasters_icon_list_items .cmsmasters_icon_list_item:before,
	{$rule}.header_mid .after_header_mid_search_wraper:before, 
	{$rule}.widget_pages ul li:before,
	{$rule}.widget_nav_menu ul li:before {
	...
	{$rule}.post_nav .cmsmasters_next_post:hover .cmsmasters_next_arrow,
	{$rule}input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]),
	{$rule}.comment-form-comment textarea,
	{$rule}.cmsmasters_pings_list .pingslist .trackback,
	{$rule}.wp-caption .wp-caption-text,
	{$rule}.share_posts {
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['scandi' . '_' . $scheme . '_link']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['scandi' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['scandi' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
/***************** Start {$title} Button Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_button.cmsmasters_but_icon_divider:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['scandi' . '_' . $scheme . '_bg']) . "
	}
...
";
	...
	return apply_filters('scandi_theme_colors_primary_filter', $custom_css);
}
