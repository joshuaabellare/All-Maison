...
if ($cmsmasters_post_format == 'image') {
			...
			if ($cmsmasters_post_image_link != '' || has_post_thumbnail()) {
				echo '<div class="cmsmasters_media_wrap">';
					...
					scandi_post_type_image(get_the_ID(), $cmsmasters_post_image_link, 'cmsmasters-full-masonry-thumb');
			...
			if ((!empty($empty_test_array) && sizeof($cmsmasters_post_images) > 0) || has_post_thumbnail()) {
				echo '<div class="cmsmasters_media_wrap">';
					...
					scandi_post_type_slider(get_the_ID(), $cmsmasters_post_images, 'post-thumbnail', $slider_data);
			...
			echo '<div class="cmsmasters_media_wrap">';
				...
				scandi_thumb(get_the_ID(), 'post-thumbnail', true, false, false, false, false, true, false);
	...
	<div class="cmsmasters_post_cont">
		...
		if ($author || $date) {
			echo '<div class="cmsmasters_post_cont_info entry-meta">';
				...
				$date ? scandi_get_post_date('page', 'default') : '';
